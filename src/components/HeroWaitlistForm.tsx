        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input
              ...
              required
              className="block w-full pl-10 pr-3 py-3 border border-black/20 rounded-full bg-white/10 text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black/50 focus:border-transparent"
            />
          </div>
          {error && (
